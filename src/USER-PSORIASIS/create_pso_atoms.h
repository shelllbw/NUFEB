...
CommandStyle(create_pso_atoms,CreatePsoAtoms)

#else

#ifndef LMP_CREATE_PSO_ATOMS_H
#define LMP_CREATE_PSO_ATOMS_H
...
class CreatePsoAtoms : protected Pointers {
 public:
  CreatePsoAtoms(class LAMMPS *);
 ...
 private:
  ...
  int nlocal,nall,demflag,num_sc,sc_mask;
  ...
  void add_single();
  void add_random();
  void add_stem(); // DINIKA - add stem cells
  void add_lattice();
