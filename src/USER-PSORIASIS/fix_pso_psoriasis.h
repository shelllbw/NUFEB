...
FixStyle(psoriasis/psoriasis,FixPPsoriasis)

#else

#ifndef LMP_FIX_PPSORIASIS_H
#define LMP_FIX_PPSORIASIS_H

#include "fix.h"

namespace LAMMPS_NS {

class FixPPsoriasis : public Fix {
 public:
 
	FixPPsoriasis(class LAMMPS *, int, char **);
  ~FixPPsoriasis();
  int setmask();
  void init();
